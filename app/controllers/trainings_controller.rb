...
class TrainingsController < ApplicationController
  ...
  def show
    ...
    @material = @training_exercises.map(&:equipment).reject(&:blank?)
    @material.uniq!; @material = @material.join(', ')
  ...
  def create
    ...
    if @training.save
      ...
      @exercises = find_exercises - @training.exercises
      render :index
      flash[:danger] = 'Er was een error bij het aanmaken van jouw training'
    end
  end
